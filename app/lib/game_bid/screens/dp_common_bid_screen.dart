...
class DpCommonBidScreen extends StatefulWidget {
  const DpCommonBidScreen({super.key, required this.market, required this.title});
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: GameBidUi.inputDecoration(labelText: 'Selected digits', hintText: 'Tap digits above'),
          ),
